...
public final class ShutdownThread extends Thread {
    ...
    static void shutdownInner(final Context context, boolean confirm) {
        ...
        final int titleId;
        if (mRebootSafeMode) {
            titleId = com.android.internal.R.string.reboot_safemode_title;
        } else if (mReboot) {
            titleId = com.android.internal.R.string.reboot_system;
        } else {
            titleId = com.android.internal.R.string.power_off;
        }
